...
@test "(Postfix) remove privacy details of the sender" {
  ...
  _run_in_container_bash 'find /var/mail/localhost.localdomain/user1/new/ -maxdepth 1 -type f printf "x\n"'
  assert_success
  _should_output_number_of_lines 1

  _run_in_container_bash 'grep -rE "^User-Agent:" /var/mail/localhost.localdomain/user1/new | wc -l'
  assert_success
  assert_output 0
}
